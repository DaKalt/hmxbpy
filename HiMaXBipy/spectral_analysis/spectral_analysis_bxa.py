...
# seems to not have any influence on the fit, no clue why.
    ...
    pcamod.gaussian3.LineE.values = [BckgPars[4], -1]
    pcamod.gaussian3.Sigma.values = [BckgPars[5], -1]
    pcamod.gaussian3.norm.values = [BckgPars[6], -1]
    pcamod.gaussian4.LineE.values = [BckgPars[7], -1]
    pcamod.gaussian4.Sigma.values = [BckgPars[8], -1]
    pcamod.gaussian4.norm.values = [BckgPars[9], -1]
    pcamod.gaussian5.LineE.values = [BckgPars[10], -1]
    pcamod.gaussian5.Sigma.values = [BckgPars[11], -1]
    pcamod.gaussian5.norm.values = [BckgPars[12], -1]
    pcamod.gaussian6.LineE.values = [BckgPars[13], -1]
    pcamod.gaussian6.Sigma.values = [BckgPars[14], -1]
    pcamod.gaussian6.norm.values = [BckgPars[15], -1]
    pcamod.gaussian7.LineE.values = [BckgPars[16], -1]
    pcamod.gaussian7.Sigma.values = [BckgPars[17], -1]
    pcamod.gaussian7.norm.values = [BckgPars[18], -1]
    pcamod.gaussian8.LineE.values = [BckgPars[19], -1]
    pcamod.gaussian8.Sigma.values = [BckgPars[20], -1]
    pcamod.gaussian8.norm.values = [BckgPars[21], -1]
    pcamod.gaussian9.LineE.values = [BckgPars[22], -1]
    pcamod.gaussian9.Sigma.values = [BckgPars[23], -1]
    pcamod.gaussian9.norm.values = [BckgPars[24], -1]
    pcamod.gaussian10.LineE.values = [BckgPars[25], -1]
    pcamod.gaussian10.Sigma.values = [BckgPars[26], -1]
    pcamod.gaussian10.norm.values = [BckgPars[27], -1]
    pcamod.gaussian11.LineE.values = [BckgPars[28], -1]
    pcamod.gaussian11.Sigma.values = [BckgPars[29], -1]
    pcamod.gaussian11.norm.values = [BckgPars[30], -1]
    pcamod.gaussian12.LineE.values = [BckgPars[31], -1]
    pcamod.gaussian12.Sigma.values = [BckgPars[32], -1]
    pcamod.gaussian12.norm.values = [BckgPars[33], -1]
    pcamod.gaussian13.LineE.values = [BckgPars[34], -1]
    pcamod.gaussian13.Sigma.values = [BckgPars[35], -1]
    pcamod.gaussian13.norm.values = [BckgPars[36], -1]
    pcamod.gaussian14.LineE.values = [BckgPars[37], -1]
    pcamod.gaussian14.Sigma.values = [BckgPars[38], -1]
    pcamod.gaussian14.norm.values = [BckgPars[39], -1]
    pcamod.gaussian15.LineE.values = [BckgPars[40], -1]
    pcamod.gaussian15.Sigma.values = [BckgPars[41], -1]
    pcamod.gaussian15.norm.values = [BckgPars[42], -1]
    ...
    pcamod.powerlaw19.PhoIndex.values = [BckgPars[54], -1]
    pcamod.powerlaw19.norm.values = [BckgPars[55], -1]
    pcamod.gaussian20.LineE.values = [BckgPars[56], -1]
    pcamod.gaussian20.Sigma.values = [BckgPars[57], -1]
    pcamod.gaussian20.norm.values = [BckgPars[58], -1]
    pcamod.powerlaw21.PhoIndex.values = [BckgPars[59], -1]
    pcamod.powerlaw21.norm.values = [BckgPars[60], -1]
    pcamod.gaussian22.LineE.values = [BckgPars[61], -1]
    pcamod.gaussian22.Sigma.values = [BckgPars[62], -1]
    pcamod.gaussian22.norm.values = [BckgPars[63], -1]
    pcamod.gaussian23.LineE.values = [BckgPars[64], -1]
    pcamod.gaussian23.Sigma.values = [BckgPars[65], -1]
    pcamod.gaussian23.norm.values = [BckgPars[66], -1]
    pcamod.gaussian24.LineE.values = [BckgPars[67], -1]
    pcamod.gaussian24.Sigma.values = [BckgPars[68], -1]
    pcamod.gaussian24.norm.values = [BckgPars[69], -1]
    pcamod.gaussian25.LineE.values = [BckgPars[70], -1]
    pcamod.gaussian25.Sigma.values = [BckgPars[71], -1]
    pcamod.gaussian25.norm.values = [BckgPars[72], -1]
    pcamod.gaussian26.LineE.values = [BckgPars[73], -1]
    pcamod.gaussian26.Sigma.values = [BckgPars[74], -1]
    pcamod.gaussian26.norm.values = [BckgPars[75], -1]
    pcamod.gaussian27.LineE.values = [BckgPars[76], -1]
    pcamod.gaussian27.Sigma.values = [BckgPars[77], -1]
    pcamod.gaussian27.norm.values = [BckgPars[78], -1]
    pcamod.gaussian28.LineE.values = [BckgPars[79], -1]
    pcamod.gaussian28.Sigma.values = [BckgPars[80], -1]
    pcamod.gaussian28.norm.values = [BckgPars[81], -1]
    pcamod.gaussian29.LineE.values = [BckgPars[82], -1]
    pcamod.gaussian29.Sigma.values = [BckgPars[83], -1]
    pcamod.gaussian29.norm.values = [BckgPars[84], -1]
